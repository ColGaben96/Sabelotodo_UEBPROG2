...
public class Panel_preguntas extends JPanel implements Runnable {
	...
	public Panel_preguntas() {
		...
		im= new ImageIcon(("imagenes/Presentaci�n1.jpg"));
	...
	public void alertQuit() {
		var ans = JOptionPane.showConfirmDialog(null, "Al salir te sacar� de la partida actual y volver�s al men� principal", "�Salir?", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
